...
const translations = {
    en: {
        settings: {
            ...
            autoRelink: "Auto-relink media after export",
            autoImport: "Auto-import",
            autoImportInterval: "Auto-import interval (seconds)",
            excludedFolders: "Folders excluded from export",
    ...
    fr: {
        settings: {
            ...
            autoRelink: "Relier automatiquement les médias après l'export",
            autoImport: "Import automatique",
            autoImportInterval: "Intervalle d'import auto (secondes)",
            excludedFolders: "Dossiers exclus de l'export",
